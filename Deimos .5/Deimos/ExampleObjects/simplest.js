...
(function() {
    ...
    function getCurveVertex(drawingState){
        return curveArrayA[0];
    };
    ...
    var pyramid = {
        ...
        draw : function(drawingState) {
            ...
            var curveVertex = getCurveVertex;
            twgl.m4.setTranslation(model, curveVertex, model);
